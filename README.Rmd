...
1. Download and install the PostgreSQL ODBC driver from [https://www.postgresql.org/ftp/odbc/versions/msi/](https://www.postgresql.org/ftp/odbc/versions/msi/). You'll need to scroll down to the most recent file ending x64.zip and click on it to download.
